...
document.getElementById('btn').onclick = function () {
    ...
    if (randomNumber == userInput) {
        document.getElementById('ans').innerHTML = `<i class="fa-solid fa-circle-check"></i> You take ${score}  Chances to complete the game`;
        ...
        score++
        document.getElementById('ans').innerHTML = `<i class="fa-solid fa-triangle-exclamation"></i>Your guess is less than that number`;
